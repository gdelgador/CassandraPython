...
class Producto:
    def __init__(self, IdProducto,Nombre,Precio, Existencias, Propiedades):
        self.IdProducto = IdProducto
        self.Nombre = Nombre
        self.Precio =Precio
...
def insertCliente ():
	...
	#Implementar inserción tabla soporte ejercicio 5 debajo
...
def borrarPedidoFecha (): #Ejercicio 3
    pass #Borrar cuando se haga ejercicio
